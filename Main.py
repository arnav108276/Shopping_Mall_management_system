...
db=mysql.connector.connect(user="root",password="passkey=00",host="localhost") 
...
db=mysql.connector.connect(user="root",password="passkey=00",host="localhost",database='devops') 
my_cursor=db.cursor()
...
db=mysql.connector.connect(user="root",passwd="passkey=00",host="localhost",database='devops') 
my_cursor=db.cursor()
...
def bill():
    ...
    headingLabel = Label(headingFrame1, text="Bill", fg='grey19', font=('Courier',25,'bold'))
    headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
